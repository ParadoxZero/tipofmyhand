...
export default function Profile() {
    ...
    return (
        <section className="relative">
            ...
            <h1 className="h2 mb-4">Meet us</h1>
            <p className="text-xl text-gray-600">
              We are a pair of Software Engineers who got the idea of this simple service after being the 
            ...
            <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl md:max-w-sm rounded-xl">
                <div className="pb-6">
                    ...
                    <div className="mt-2 mt-20 text-center">
                        <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700">Sidhin S Thomas</h3>
                        <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                            <div className="text-sm font-bold tracking-wide text-gray-600 font-mono text-xl">Software Engineer</div>
                        </div>
                        <div className="w-full text-center">
                            <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                                <div className="flex space-x-2">
                                    <a className="p-1 -m-1 text-gray-400 hover:text-blue-500 focus:outline-none focus-visible:ring-2 ring-primary" href="https://www.github.com/ParadoxZero" rel="noopener" aria-label="Sidhin on Github" target="_blank">
                                    ...
                                    <a
                                        ...
                                        href="https://www.linkedin.com/in/sidhin/"
                                        rel="noopener"
                                        aria-label="Sidhin on Linkedin"
                                        target="_blank"
                                    >
                                        <svg className="w-6 h-6 overflow-visible fill-current" aria-hidden="true" viewBox="0 0 140 140">
                                            <path
                                    ...
                                    <a
                                        className="p-1 -m-1 text-gray-400 hover:text-blue-500 focus:outline-none focus-visible:ring-2 ring-primary"
                                        href="https://www.instagram.com/the_paradox_zero"
                                        rel="noopener"
                                        aria-label="Sidhin on Instagram"
                                        target="_blank"
                                    >
        ...
        <div className='flex items-center justify-center min-h-screen'>
            <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl md:max-w-sm rounded-xl">
                <div className="pb-6">
                    ...
                    <div className="mt-2 mt-20 text-center">
                        <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700">Sherin Ann Thomas</h3>
                        <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                            <div className="text-sm font-bold tracking-wide text-gray-600 font-mono text-xl">Software Engineer</div>
                        </div>
                        <div className="w-full text-center">
